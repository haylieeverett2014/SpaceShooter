...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 4703849;
      var PACKAGE_UUID = '973674dd-bcd4-4b46-b971-903f4422b75d';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 2240718, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(2240718, 2240739, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(2240739, 2244668, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(2244668, 3801252, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(3801252, 4676224, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(4676224, 4703849, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');

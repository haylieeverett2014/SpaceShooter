...
struct Matrix4x4U5BU5D_t2328801282  : public Il2CppArray
{
public:
	ALIGN_FIELD (8) Matrix4x4_t2933234003  m_Items[1];

public:
	inline Matrix4x4_t2933234003  GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Matrix4x4_t2933234003 * GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
	inline void SetAt(il2cpp_array_size_t index, Matrix4x4_t2933234003  value)
	{
		m_Items[index] = value;
	}
};
...
public:
	inline Material_t193706927 * GetAt(il2cpp_array_size_t index) const { return m_Items[index]; }
	inline Material_t193706927 ** GetAddressAt(il2cpp_array_size_t index) { return m_Items + index; }
